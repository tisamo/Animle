...
import {GuessGameResolver} from "./shared/services/resolvers/guess-game.resolver";

export const routes: Routes = [
  {path: '', loadComponent: () => import('./pages/home/home.component').then((mod=> mod.HomeComponent))},
  {path: 'daily', resolve:{data: DailyAnimeResolver},  loadComponent: () => import('./pages/emoji/emoji.component').then((mod=> mod.EmojiComponent))},
  ...
  {path: 'quiz', resolve: {quizList: QuizlistResolver}, loadComponent: () => import('./pages/user-made-quizes/user-made-quizes.component').then((mod=> mod.UserMadeQuizesComponent))},
  ...
  {path: 'quiz/edit/:id', canActivate: [AuthGuard],  resolve:{data: QuizResolver}, loadComponent: () => import('./pages/create-quiz/create-quiz.component').then((mod=> mod.CreateQuizComponent))},
  ...
  {path: 'guess-game', resolve: {data: GuessGameResolver}, loadComponent: () => import('./pages/guess-game/guess-game.component').then((mod=> mod.GuessGameComponent))},
